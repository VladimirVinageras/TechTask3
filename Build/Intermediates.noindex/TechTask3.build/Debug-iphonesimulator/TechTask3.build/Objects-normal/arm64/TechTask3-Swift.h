...
#ifndef TECHTASK3_SWIFT_H
#define TECHTASK3_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TechTask3",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9TechTask311AppDelegate")
...
SWIFT_CLASS("_TtC9TechTask319ImageCollectionCell")
...
SWIFT_CLASS("_TtC9TechTask324MainScreenViewController")
...
@interface MainScreenViewController (SWIFT_EXTENSION(TechTask3)) <CHTCollectionViewDelegateWaterfallLayout, UICollectionViewDataSource>
...
SWIFT_CLASS("_TtC9TechTask313SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
